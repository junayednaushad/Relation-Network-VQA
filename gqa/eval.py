...
# python eval.py --consistency 

parser = argparse.ArgumentParser()
parser.add_argument('--tier',           default = "val",                     type = str,    help = "Tier, e.g. train, val")
parser.add_argument('--scenes',         default=".\\data\\{tier}_sceneGraphs.json",   type = str,    help = "Scene graphs file name format.")
parser.add_argument('--questions',      default=".\\data\\{tier}_all_questions.json", type = str,    help = "Questions file name format.")
parser.add_argument('--choices',        default=".\\data\\{tier}_choices.json",       type = str,    help = "Choices file name format.")
parser.add_argument('--predictions',    default=".\\data\\{tier}_predictions.json",   type = str,    help = "Answers file name format.")
parser.add_argument('--attentions',     default=".\\data\\{tier}_attentions.json",    type = str,    help = "Attentions file name format.")
